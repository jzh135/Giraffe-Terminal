    ...
    <div>
      ...
      <div className="stats-grid">
        ...
        <div className="stat-card">
          ...
          <div
            className={`stat-value ${(performance?.spy_return || 0) >= 0 ? 'positive' : 'negative'}`}
          >
            {performance?.spy_return !== null ? formatPercent(performance.spy_return) : 'N/A'}
          </div>
        </div>
        ...
        <div className="stat-card">
          ...
          {performance?.spy_return !== null && (
            <div
              className={`stat-value ${(performance?.twr || 0) - (performance?.spy_return || 0) >= 0 ? 'positive' : 'negative'}`}
            >
        ...
        <div className="stats-grid" style={{ marginBottom: '1rem' }}>
          ...
          <div>
            ...
            >
              ...
              {totalCostBasis > 0 ? formatPercent((totalGainLoss / totalCostBasis) * 100) : '0%'})
            </div>
          </div>
        </div>
      </div>
              ...
              {portfolioBreakdown.map((p) => {
                ...
                return (
                  <tr key={p.symbol}>
                    ...
                    <td
                      className={`text-right ${p.gainLoss >= 0 ? 'text-positive' : 'text-negative'}`}
                    >
          ...
          <div style={{ height: 300 }}>
            <ResponsiveContainer width="100%" height="100%">
              <LineChart data={performance.cash_flows}>
                ...
                <XAxis dataKey="date" stroke="#9090a0" tick={{ fill: '#9090a0' }} />
                <YAxis
                  stroke="#9090a0"
                  tick={{ fill: '#9090a0' }}
